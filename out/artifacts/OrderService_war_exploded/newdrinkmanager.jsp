    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#drinktype").html("<option value='0'>请选择口味...</option> "+optionstring);
            ...
            if(drink_id!="")
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success==1){
                            alert("修改成功");
                            var newpage="drinkManager.do?shop_id="+"${drink.shop_id}";
                            window.open(newpage);
                        }
                        else{
                            alert("修改失败,请稍后重试");
